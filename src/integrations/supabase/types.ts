  ...
  public: {
    Tables: {
      audit_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "audit_logs_requisicao_id_fkey"
      ...
      comentarios: {
        ...
        Relationships: [
          {
            foreignKeyName: "comentarios_requisicao_id_fkey"
            columns: ["requisicao_id"]
            isOneToOne: false
            referencedRelation: "requisicoes"
            referencedColumns: ["id"]
      ...
      requisicoes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "requisicoes_comprador_id_fkey"
    ...
    Enums: {
      app_role: "admin" | "comprador" | "gerente" | "solicitante"
      requisicao_prioridade: "ALTA" | "MEDIA" | "BAIXA"
      requisicao_status:
        | "pendente"
        | "em_analise"
        | "aprovado"

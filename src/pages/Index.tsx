      ...
      <div className="flex items-center gap-6 text-white">
        <div className="flex items-center gap-2 cursor-pointer hover:opacity-80">
          ...
          <div className="flex flex-col leading-tight">
            <span className="text-[10px] font-medium">Unidade</span>
        ...
        <div className="flex items-center gap-2 cursor-pointer hover:opacity-80">
          <User size={24} />
          <div className="flex flex-col leading-tight">
            <span className="text-[10px] font-medium">Departamento</span>
  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-[#008651] selection:text-white">
      ...
      <main className="w-full">
        {/* === HERO SECTION === */}
        <section className="relative px-6 md:px-12 pt-16 pb-24 lg:pt-20 lg:pb-28 overflow-hidden">

...
// ==================================================================================
// HERO BENTO GRID - VERSÃO ULTRA MODERNA (ATUALIZADO)
// Foco: Design "Tech", Gráficos CSS Vivos e Glassmorphism
// ==================================================================================

const HeroBentoGrid = () => {
  return (
    <div className="w-full max-w-[580px] h-[420px] grid grid-cols-2 grid-rows-2 gap-4 lg:ml-auto scale-[0.9] md:scale-100 origin-center lg:origin-right select-none font-sans">
      {/* === BLOCO 1: AGILIDADE (PRINCIPAL) === */}
      <div className="row-span-2 bg-gradient-to-br from-[#008651] to-[#005c3b] rounded-[2rem] p-7 flex flex-col justify-between shadow-2xl shadow-green-900/20 relative overflow-hidden group border border-white/10 transition-all hover:scale-[1.01] duration-500">
